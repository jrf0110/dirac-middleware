...
var without = function( objA, keys ){
  if ( !keys ) return objA;
  ...
  return function(req, res){
    ...
    if ( collection ){
      ...
      args.push( function( error, results ){
        ...
        res.render( name, without( options, [ 'notFound', 'error' ] ) );
      });
...
m.find = function(collection, options){
  options = options || {};
  return function(req, res){
    collection = collection || req.collection;
    ...
    collection.find(req.queryObj, req.queryOptions, function(error, results){
      ...
      if (options.callback && typeof options.callback === 'function')
        options.callback(error, results);
...
m.findOne = function(collection, options){
  options = options || {};
  return function(req, res){
    collection = collection || req.collection;
...
m.insert = function(collection, options){
  options = options || {};
  return function(req, res){
    collection = collection || req.collection;
    ...
    collection.insert(req.body, req.queryOptions, function(error, results){
      ...
      var val = results.length > 0 ? results[0] : results;
...
m.remove = function(collection, options){
  options = options || {};
  return function(req, res){
    collection = collection || req.collection;
